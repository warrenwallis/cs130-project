...
import { collection, getFirestore, doc, addDoc, getDoc, getDocs, setDoc, serverTimestamp } from 'firebase/firestore';
...
export { collection, auth, firestore, app, db, doc, addDoc, setDoc, getDoc, getDocs, serverTimestamp };
