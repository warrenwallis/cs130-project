...
import { collection, getFirestore, doc, addDoc, setDoc, serverTimestamp } from 'firebase/firestore';
...
export { collection, auth, firestore, app, db, doc, addDoc, setDoc, serverTimestamp };
